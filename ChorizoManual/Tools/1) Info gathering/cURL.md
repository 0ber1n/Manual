...
$ curl -X POST -d '{"search":"Denver"}' -b 'PHPSESSID=r4nuurljr9acq4s8ra2uithbkb' -H 'Content-Type: application/json' [http://94.237.48.48:54608/search.php](http://94.237.48.48:54608/search.php) 
