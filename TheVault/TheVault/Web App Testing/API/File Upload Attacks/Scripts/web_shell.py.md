```python
# utilize the following script in a php upload file then call the python script
...
# After creating webshell, you can also open netcat lsiteneter and have a more interactive shell by running:
